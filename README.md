...
<p align="center">
  <strong>A full desktop port of KittyTune / InnerTune for Linux, Windows, and macOS.</strong><br>
...
KittyTune Desktop is a complete, native desktop port of the Android music application [InnerTune](https://github.com/z-huang/InnerTune) / KittyTune. Built from the ground up using **Kotlin 2.4.0**, **Compose Multiplatform (Skiko)**, and **Material 3 Expressive**, it brings the full Android mobile experience natively to Linux, Windows, and macOS desktops.
...
*   **Real-time synchronized lyrics**: Powered by LrcLib, KuGou, and InnerTune scrapers with word-by-word / line-by-line karaoke highlights.
...
When installed on a system running the end4 Hyprland dotfiles setup, KittyTune Desktop automatically detects the environment and reveals the **`end4 (Material You)`** palette style.
...
<p align="center">
  ...
  <br><em>The exclusive end4 (Material You) palette option in KittyTune Desktop settings.</em>
</p>

#### **why use end4 dotfiles with kittytune desktop?**
...
<p align="center">
  ...
  <br><em>MPRIS media control panel integration on Hyprland / Quickshell.</em>
</p>
...
*   Based on [InnerTune](https://github.com/z-huang/InnerTune) by z-huang.
