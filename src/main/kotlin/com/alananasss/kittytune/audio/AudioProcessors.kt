    ...
    companion object {
        ...
        fun loadNativeLibrary() {
            ...
            try {
                ...
                System.err.println("Failed to load native kittytune_audio_dsp library: ${e.message}")
            }
        }
    }
...
typealias R128AudioProcessor = NormalizationAudioProcessor
...
class GramophoneAudioProcessor : BaseAudioProcessor() {
    ...
    fun setAge(age: Float) = setShellacAge(age)
    ...
    fun setHorn(horn: Float) = setHornResonance(horn)
