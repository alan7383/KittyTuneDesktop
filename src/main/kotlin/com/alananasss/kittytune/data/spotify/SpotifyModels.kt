...
data class SpotifyTrack(
    ...
    fun toTrack(): Track {
        ...
        return Track(
            ...
            publisherMetadata = Track.PublisherMetadata(
                artist = artistName,
...
/**
 * Dominant colors Spotify extracts from cover art (fetchExtractedColors op).
 * [raw] is the dominant color; [dark]/[light] are contrast-adjusted variants
 * suited as accents over dark/light backgrounds. Hex strings "#RRGGBB".
 */
data class SpotifyColors(
    val raw: String,
    val dark: String,
    val light: String,
