...
object SpotifyPathfinderApi {
    ...
    object Hashes {
        ...
        /**
         * queryArtistDiscographyAll: full paginated discography of an artist.
         * The artist overview op only exposes the first page of each release
         * group; this operation walks the complete catalog.
         */
        const val ARTIST_DISCOGRAPHY_ALL = "5e07d323febb57b4a56a42abbf781490e58764aa45feb6e3dc0591564fc56599"

        /** fetchExtractedColors: cover-art color extraction for UI theming. */
        const val FETCH_EXTRACTED_COLORS = "36e90fcaea00d47c695fce31874efeb2519b97d4cd0ee1abfb4f8dc9348596ea"
    }
    ...
    fun buildArtistDiscographyUrl(artistId: String, offset: Int = 0, limit: Int = 50): String {
        val variables = JSONObject().apply {
            put("uri", "spotify:artist:$artistId")
            put("offset", offset)
            put("limit", limit)
        }
        return buildQueryUrl("queryArtistDiscographyAll", Hashes.ARTIST_DISCOGRAPHY_ALL, variables)
    }

    fun buildExtractedColorsUrl(imageUris: List<String>): String {
        val variables = JSONObject().apply {
            put("imageUris", JSONArray(imageUris))
        }
        return buildQueryUrl("fetchExtractedColors", Hashes.FETCH_EXTRACTED_COLORS, variables)
    }
