...
sealed class UploadState {
    ...
    data class Error(val messageKey: String, val formatArg: String? = null) : UploadState()
}

enum class UploadStep(val labelKey: String) {
    FETCHING_POLICY("upload_step_fetching_policy"),
    UPLOADING_FILE("upload_step_uploading_file"),
    CREATING_TRACK("upload_step_creating_track"),
    TRANSCODING("upload_step_transcoding"),
    UPLOADING_ARTWORK("upload_step_uploading_artwork"),
    DONE("upload_step_done")
}
...
fun getGenreStringKey(genre: String): String? = when (genre.lowercase().trim()) {
    "all music genres" -> "genre_all_music"
    "alternative rock" -> "genre_alternative_rock"
    "ambient" -> "genre_ambient"
    "classical" -> "genre_classical"
    "country" -> "genre_country"
    "dance & edm" -> "genre_dance_edm"
    "dancehall" -> "genre_dancehall"
    "deep house" -> "genre_deep_house"
    "disco" -> "genre_disco"
    "drum & bass" -> "genre_drum_bass"
    "dubstep" -> "genre_dubstep"
    "electronic" -> "genre_electronic"
    "folk & singer-songwriter" -> "genre_folk"
    "hip-hop & rap" -> "genre_hip_hop_rap"
    "house" -> "genre_house"
    "indie" -> "genre_indie"
    "jazz & blues" -> "genre_jazz_blues"
    "latin" -> "genre_latin"
    "metal" -> "genre_metal"
    "piano" -> "genre_piano"
    "pop" -> "genre_pop"
    "r&b & soul" -> "genre_r_b_soul"
    "reggae" -> "genre_reggae"
    ...
    "trance" -> "genre_trance"
    "trap" -> "genre_trap"
    "triphop", "trip hop", "trip-hop" -> "genre_triphop"
    "world & global", "world" -> "genre_world"
    "other" -> "genre_other"

    "audiobooks" -> "genre_audiobooks"
    "business" -> "genre_business"
    "comedy" -> "genre_comedy"
    "entertainment" -> "genre_entertainment"
    "learning" -> "genre_learning"
    "news & politics" -> "genre_news_politics"
    "religion & spirituality" -> "genre_religion_spirituality"
    "science" -> "genre_science"
    "sports" -> "genre_sports"
    "storytelling" -> "genre_storytelling"
    "technology" -> "genre_technology"
    else -> null
}
