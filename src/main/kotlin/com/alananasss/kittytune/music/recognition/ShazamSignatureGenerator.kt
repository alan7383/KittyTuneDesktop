...
internal object ShazamSignatureGenerator {
    ...
    fun fromI16(samples: ByteArray): String {
        ...
        println("DEBUG: " + "Generating fingerprint from ${samples.size} bytes of PCM data")
    ...
    private class SignatureGeneratorState {
        ...
        fun process(pcm: ShortArray): String {
            ...
            println("DEBUG: " + "Fingerprint processing complete: $numSamples samples, $totalPeaks peaks")
