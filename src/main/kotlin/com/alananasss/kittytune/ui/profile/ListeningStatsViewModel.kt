 ...
 * 3. **The screen built a new instance of this on every recomposition**, which restarted the load and
 *    reset the selected period. That is why pressing "this month" appeared to do nothing: the button
 *    worked, and a recomposition immediately replaced the object that remembered it. The screen now
