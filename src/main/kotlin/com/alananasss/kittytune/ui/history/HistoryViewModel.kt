        ...
        try {
            ...
            if (!isGuest) {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    if (trackIds.isNotEmpty()) {
                        ...
                        for (chunk in chunkedIds) {
                            try {
                                ...
                                Logger.e("HistoryViewModel", "Failed to fetch tracks chunk", e)
                            }
                        }
                        ...
                        try {
                            ...
                            Logger.e("HistoryViewModel", "Failed to cache history in DB", e)
                        }
                    ...
                    Logger.w("HistoryViewModel", "getPlayHistory returned code ${response.code()}")
                    canLoadMoreTracks = false
                }
            } else {
                canLoadMoreTracks = false
            ...
            Logger.e("HistoryViewModel", "Error loading tracks history", e)
    ...
    fun loadMoreTracks() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            try {
                ...
                Logger.e("HistoryViewModel", "Error loading more tracks", e)
                canLoadMoreTracks = false
            } finally {
        ...
        try {
            ...
            if (!isGuest) {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    Logger.w("HistoryViewModel", "getRecentlyPlayedContexts returned code ${response.code()}")
            ...
            Logger.e("HistoryViewModel", "Error loading contexts history", e)
        } finally {
    ...
    fun loadMoreContexts() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            try {
                ...
                Logger.e("HistoryViewModel", "Error loading more contexts", e)
                canLoadMoreContexts = false
            } finally {
        ...
        return try {
            when {
                ...
                urn.startsWith("soundcloud:system-playlists:artist-stations:") -> {
                    ...
                    val artistName = user?.username ?: str("history_type_artist")
                    HistoryContextItem(
                        id = "station_artist:$id",
                        urn = urn,
                        title = "$artistName Radio",
                        subtitle = str("history_type_station"),
                ...
                urn.startsWith("soundcloud:system-playlists:track-stations:") -> {
                    ...
                    val trackTitle = track?.title ?: str("history_type_station")
                    HistoryContextItem(
                        id = "station:$id",
                        urn = urn,
                        title = "$trackTitle Radio",
                        subtitle = track?.user?.username ?: str("history_type_station"),
                        imageUrl = track?.fullResArtwork,
                ...
                urn.startsWith("soundcloud:users:") -> {
                    ...
                    HistoryContextItem(
                        id = "profile:$id",
                        urn = urn,
                        title = user?.username ?: str("history_type_artist"),
                        subtitle = str("history_type_artist"),
                        imageUrl = user?.avatarUrl,
                ...
                urn.startsWith("soundcloud:liked-tracks:") -> {
                    HistoryContextItem(
                        id = "likes",
                        urn = urn,
                        title = str("history_type_likes"),
                        subtitle = str("history_source_library"),
                        imageUrl = null,
            ...
            Logger.e("HistoryViewModel", "Failed to resolve context urn $urn", e)
            null
        }
    }
                ...
                if (selectedTab == HistoryTab.TRACKS) {
                    if (!isGuest) {
                        try {
                            ...
                            Logger.e("HistoryViewModel", "Failed to clear play history on server", e)
                        }
                    }
                    ...
                    if (!isGuest) {
                        try {
                            ...
                            Logger.e("HistoryViewModel", "Failed to clear recently played contexts on server", e)
                        }
                    }
